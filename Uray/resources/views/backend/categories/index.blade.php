		                    ...
		                    <div class="row">
		                        ...
		                        <div class="col-lg-6">
		                            <ul class="breadcome-menu">
		                                <li><a href="{{ route('category.index') }}">Quản lý danh mục</a>
		                                </li>
		                                    ...
		                                    <tr>
		                                        ...
		                                        <td style="width: 125px !important;">
		                                            <div class="btn-group project-list-action">
		                                                ...
		                                                <div class="modal fade" id="{{'UpdateCategory'.$category->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
		                                                    <div class="modal-dialog modal-dialog-centered" role="document">
		                                                        <div class="modal-content">
		                                                            ...
		                                                            <div class="modal-body">
		                                                               <form role="form" method="post" action="{{route('category.update',['id'=>$category->id])}}" id="{{'form-edit'.$category->id}}">
		                                                                    {{ csrf_field() }}
		                                                            ...
		                                                            <div class="modal-footer">
		                                                                ...
		                                                                <button form="{{'form-edit'.$category->id}}" type="submit" class="btn btn-primary">Sửa</button>
		                                                                </form>
		                                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Đóng</button>
		                                                            </div>
		                                                ...
		                                                <form role="form" action="{{ route('category.destroy',['id'=>$category->id])}}" method="POST" style="float: left;">
		                                                    {{ csrf_field() }}
