				...
				<div class="panel-body">
					<form role="form" method="POST" action="{{ url('/register') }}" enctype="multipart/form-data">
						...
						<div class="form-group has-warning">
			                <label>Họ tên</label>
			                <input type="text" class="form-control" id="inputWarning" placeholder="Họ tên" name="name">
			                <label>Email</label>
			                ...
			                <input type="text" class="form-control" id="inputWarning" placeholder="Số điện thoại" name="phone">
			                <label>Địa chỉ</label>
